      ...
      <Navbar className={css(styles.menuContainer)}>
        ...
        <Nav>
          ...
          <ul className={css(styles.subMenuCol)}>
            <li onClick={() => this.setState({ activeMenu: 'projects' })} className={css(styles.subMenuLink)}>
              <b>projects</b>
            </li>
            {
        ...
        {/* ############# STUDIO SECTION ############# */}
          <ul className={css(styles.subMenuCol)}>
            <li onClick={() => this.setState({ activeMenu: 'studio' })} className={css(styles.subMenuLink)}>
              <b>studio</b>
            </li>
            {
        ...
        {/* ############# CONTACT SECTION ############# */}
          <ul className={css(styles.subMenuCol)}>
            <li onClick={() => this.setState({ activeMenu: 'contact' })} className={css(styles.subMenuLink)}>
              <b>contact</b>
            </li>
            {
