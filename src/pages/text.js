        ...
        <div className={css(styles.textRightColumn)}>
          ...
          <div className={css(styles.textText)}>
            <h2 className={css(styles.textHeader)}>
              What is behind a laughter and how we came to name our studio after
              it.{' '}
            </h2>
            <br />
            <br />
            ...
            <p className={css(styles.textParagraph)}>
              ...
              design similarly. Naive - in the form only - the design we want to
              make promote emotions and intuitive expression. Inclusive - but
              not for the mass - our design search to cross boundaries without
              losing quality. As designers, we focus on form and emotion, but
              also on qualitative materials, techniques, and concepts.
            </p>
            <br />
          </div>
