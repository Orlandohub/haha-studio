  ...
  <Layout location={location}>
    ...
    <div className={css(styles.termsLicensesWrapper)}>
      ...
      <div className={css(styles.termsLicensesTextWrapper)}>
        ...
        <br />
        <br />
        Any offer, quotation or price information by Neubau regarding the fonts,
        text, graphics and any other items accessed from or via this Website or
        otherwise through the internet (“Own Content”) is without obligation and
        subject to change without notice unless an offer has been designated as
        binding.
        <br />
        Neubau expressly reserves itself the right to change, amend, cancel or
        close down parts or the entire Own Content and the Website definitively
        or from time to time. Neubau makes no warranties, express or implied,
        that its services will be uninterrupted, error-free or free of viruses
        or other harmful components, unless respective faults were caused by
        Neubau by act of gross negligence or intent.
        <br />
        <br />
        § 2 Contract
        <br />
        ...
        Neubau by placing an order.
        <br />
        When placing an order for physical goods, the order shall be deemed to
        be accepted by Neubau either upon subsequent (e-mail) acceptance of the
        order or by dispatching the product.
        <br />
        <br />
        ...
        with § 356 (5) German Civil Code (BGB) and hereby expressly consents to
        and accepts by placing an order:
        <br />
        (i) that Neubau executes the contract prior to the end of the withdrawal
        period; and
        <br />
        ...
        contract with Neubau within 14 days without giving any reason.
        <br />
        ...
        Paul-Lincke-Ufer 44a, 10999 Berlin, of the decision to withdraw from the
        contract by an unequivocal statement (e.g. a letter sent by post, fax or
        e-mail). The Customer may use the attached model withdrawal form, but
        ...
        <br />
        <br />
        If the Customer withdraws from this contract, Neubau shall reimburse to
        the Customer all payments received from the Customer, including the
        ...
        on which Neubau is informed about the Customer’s decision to withdraw
        from the contract. Neubau will carry out such reimbursement using the
        same means of payment as the Customer used for the initial transaction,
        unless the Customer has expressly agreed otherwise; in any event, the
        Customer will not incur any fees as a result of such reimbursement.
        Neubau may withhold reimbursement until Neubau has received the goods
        back or the Customer has supplied evidence of having sent back the
        ...
        Neubau. The deadline is met if The Customer sends back the goods before
        the period of 14 days has expired. The Customer will have to bear the
        direct cost of returning the goods. The Customer is only liable for any
        diminished value of the goods resulting from the handling other than
        ...
        <br />
        <br />
        Neubau shall not be liable for content in guest books, discussion forums
        and chats which are provided by third parties (“Third Party Content”).
        Any of such Third Party Content does not necessarily represent the
        opinions, beliefs, or positions of Neubau. Please notify Neubau to
        abc[at]neubauladen.com of any illegal or offensive Third Party Content.
        <br />
        <br />
        ...
        extent necessary for the purpose of the execution and implementation of
        the contracts and as long as Neubau is required to keep such data in
        accordance with applicable law. Neubau shall not make available any
        personal data of the Customer to other third parties without the express
        consent of the Customer, except to the extent that a disclosure is
