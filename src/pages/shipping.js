    ...
    <Layout location={location}>
      <div className={css(styles.shippingWrapper)}>
        ...
        <div className={css(styles.shippingTextWrapper)}>
          ...
          purchased. Lighting products take 2-3 weeks of leading time to
          prepare. The shipping usually takes 5-7 business days to arrive at
          your address. For further information regarding shipping please email
        ...
        <div className={css(styles.shippingTextWrapper)}>
          ...
          <p className={css(styles.disclaimerStyles)}>
            * Here will be a line to state that the shipping fee could be vary
            due to the certain circumstances. Terms here has to be well thought,
